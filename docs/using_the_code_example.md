...
The following example clones the "[Multicore Live Firmware Update](https://github.com/Infineon/mtb-example-ce242384-multicore-live-fwu)" application with the desired name "MulticoreLiveFwu" configured for the *KIT_PSC3M8_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC3M8_EVK --app-id mtb-example-ce242384-multicore-live-fwu --user-app-name MulticoreLiveFwu --target-dir "C:/mtb_projects"
   ```
